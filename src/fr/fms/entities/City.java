...
public class City {
	...
	/*	*//**
			 * methode toString
			 *//*
				 * @Override public String toString() { if (getNbInhabitants()==0) { return
				 * "Ville de naissance : "+ getCityName() + " , " + getCountry(); }else { return
				 * "Ville de naissance : "+getCityName() + " , " + getCountry() + " , " +
